                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea wire:model="tambah_penyedia.alamat" id="alamat_penyedia" class="form-control" style="height: 50px" required></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input wire:model="tambah_penyedia.tahun_berdiri" type="number" min="2000"
                                    max="2100" class="form-control" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="nohp_penyedia" class="col-sm-2 col-form-label">No HP</label>
                            <div class="col-sm-10">
                                <input wire:model="tambah_penyedia.nohp" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="row mb-3">
