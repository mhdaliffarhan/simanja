      ...
      <div class="card-body">
        ...
        <form wire:submit.prevent="simpan">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input wire:model="data_produk.kode" type="text" class="form-control" value="{{$produk->kode}}" disabled>
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputText" class="col-sm-2 col-form-label">Nama</label>
                <div class="col-sm-10">
                    <input wire:model="data_produk.nama" type="text" class="form-control" value="{{$produk->nama}}">
                </div>
            </div>
            <div class="row mb-3">
                <label for="inputText" class="col-sm-2 col-form-label">Satuan</label>
                <div class="col-sm-10">
                    <input wire:model="data_produk.satuan" type="text" class="form-control" value="{{$produk->satuan}}">
                </div>
            </div>
